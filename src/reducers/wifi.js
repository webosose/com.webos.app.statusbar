import { CLEAR_LOADING, CLEAR_SECURITY_PAGE, LOADING_WIFI_LIST, SET_WIFI_ERROR, SET_WIFI_LIST, SET_WIFI_STATE, SET_WIFI_STATUS, SHOW_SECURITY_PAGE,SET_WIFI_ERROR_MESSAGE } from "../actions/actionNames";
...
export const setWifiErrorMessage = (state=null,action) => {
	switch (action.type) {
		case SET_WIFI_ERROR_MESSAGE:
			return action.payload;
		default:
			return state;
	}
